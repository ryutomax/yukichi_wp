      ...
      <div class="p-footer-inner">
        ...
        <ol class="p-footer-icons">
          <a href="https://www.facebook.com/lapin20150209/" class="p-footer-icon" terget="_blank" rel="noopener noreferrer">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/'); ?>assets/images/icons/Facebook_icon.png" alt="Facebook 諭吉そば 心躍る、うまいラーメンを" class="p-footer-icon-img">
          </a>
          <a href="https://www.instagram.com/?hl=ja" class="p-footer-icon" terget="_blank" rel="noopener noreferrer">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/'); ?>assets/images/icons/Instagram_icon.png" alt="Instagram 諭吉そば 心躍る、うまいラーメンを" class="p-footer-icon-img">
          </a>
          <a href="https://twitter.com/sobacchan_m" class="p-footer-icon" terget="_blank" rel="noopener noreferrer">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/'); ?>assets/images/icons/X_icon.png" alt="X 諭吉そば 心躍る、うまいラーメンを" class="p-footer-icon-img">
          </a>
